...
<div class="form-container">
    ...
    {{-- Ce formulaire enverra une requête POST à la route nommée ouvrages.update avec l'ID de l'ouvrage à mettre à jour. --}}
        ...
        <div class="form-group"> 
                ...
                {{-- Cet élément select permet à l'utilisateur de sélectionner plusieurs auteurs pour l'ouvrage, avec les auteurs actuels déjà sélectionnés. --}}
                ...
                {{-- Similaire à la sélection des auteurs, cet élément select permet à l'utilisateur de sélectionner plusieurs genres pour l'ouvrage, avec les genres actuels déjà sélectionnés. --}}
